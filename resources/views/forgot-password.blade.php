    ...
    @if ($route == 'client-login' or $route == 'rider-login')
        <div class="d-flex justify-content-center align-items-center" style="height: 80vh">
            <div style="max-width: 30rem; width: 100%" class="p-5">
                ...
                <div class="mb-2 mb-xxl-3">
                    <label for="code" class="form-label col-form-label col-form-label-sm display-7 fw-normal">Confirmation
                        Code
                    </label>
                    <input type="text" name="code" class="form-control form-control-sm py-2 py-xxl-3 fw-light" id="code"
